...
const Home = () => {
  ...
  return (
    <div className="pt-5">
      <div className="w-fill flex justify-center items-center h-[250px] bg-gradient-to-r from-[#4c76cf] to-[#552ab8] relative rounded-md overflow-hidden">
        <button
          onClick={() => {
            setShow(!show);
          }}
          className="px-4 py-2 text-[15px] overflow-hidden text-center bg-[#8b3dffad] text-white rounded-[3px] font-medium hover:bg-[#8b3dffad] absolute top-3 right-3"
        >
          Custom Size
        </button>
        <div
        ...
        >
          ...
          <button onClick={create} className="px-4 py-2 text-[13px] overflow-hidden text-center bg-[#8b3dffad] w-full text-white rounded-[3px] font-medium hover:bg-[#8b3dffad]">
            Create New Design
          </button>
        </div>
        <div>
...
<Link className="w-full h-full block bg-[#ffffff12] p-4 rounded-md">
    <img className="w-full h-full rounded-md overflow-hidden" src={canvacover} alt="cover" />
</Link>
